...
namespace snp {
    ...
    public:
        ...
        int createSVMModelFromSNPFile(std::string snpFileName, unsigned long int neighbors, sequence::FastaFactory &chrFactory, kmers::KmersFactory& kmersFactory, svm::SVMPredict& svmPredict, fimo::FimoFactory & fimoFactory, tfbs::TFBSFactory & tFBSFactory, std::string &outputFileName);
    private:
